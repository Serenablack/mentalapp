...
public class AIActivitySuggestionServiceImpl implements AIActivitySuggestionService {
    ...
    private void validateApiConfiguration() {
        if (geminiApiKey == null || geminiApiKey.trim().isEmpty() || "your_gemini_api_key_here".equals(geminiApiKey)) {
            throw new RuntimeException(
                    "Gemini API key not configured properly. Please set GEMINI_API_KEY environment variable.");
        }
    ...
    private String generatePrompt(MoodEntry moodEntry) {
        ...
        prompt.append(
                "As a mental health assistant, analyze the following mood entry and suggest 3 personalized activities ");
        ...
        prompt.append("- Comfort Environment: ")
                .append(moodEntry.getComfortEnvironment() != null ? moodEntry.getComfortEnvironment() : "Not specified")
                .append("\n");
        prompt.append("- Description: ")
                .append(moodEntry.getDescription() != null ? moodEntry.getDescription() : "Not provided").append("\n");
        prompt.append("- Energy Level (1-5): ")
                .append(moodEntry.getEnergyLevel() != null ? moodEntry.getEnergyLevel() : "Not specified").append("\n");
        prompt.append("- Passion/Interest: ")
                .append(moodEntry.getPassion() != null ? moodEntry.getPassion() : "Not specified").append("\n");
        ...
        prompt.append("{\n");
        prompt.append("  \"description\": \"string (detailed description of the activity, 50-200 characters)\"\n");
        prompt.append("}\n\n");
        prompt.append(
                "Ensure each activity is unique, doable either alone or in group, and appropriate for mental health improvement. ");
    ...
    private List<Map<String, Object>> parseActivitiesFromContent(String content) {
        try {
            ...
            if (startBracket != -1 && endBracket != -1 && endBracket > startBracket) {
                ...
                List<Map<String, Object>> activities = objectMapper.readValue(jsonArray,
    ...
    private SuggestedActivity createActivityFromGeminiResponse(Map<String, Object> activityData, MoodEntry moodEntry) {
        ...
        activity.setActivityDescription(
                getStringValue(activityData, "description", "Beneficial activity for your current mood"));
